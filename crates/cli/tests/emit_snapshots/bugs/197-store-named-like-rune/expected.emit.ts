...
async function $$render_f1b3ae29() {
    type $$Events = {};
...
const __svn_component_default: import('svelte').Component<
    Awaited<ReturnType<typeof $$render_f1b3ae29>>['props'],
    Awaited<ReturnType<typeof $$render_f1b3ae29>>['exports'],
    Awaited<ReturnType<typeof $$render_f1b3ae29>>['bindings']
> = null as any;
...
// generated by svelte-check-native; do not edit
    import { writable } from 'svelte/store';
async function $$render_fb034a7c() {
    let $state!: __SvnStoreValue<typeof state>;
