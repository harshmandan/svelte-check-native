...
async function $$render_e40e2c10() {
    ...
    ;(async () => {
        ...
        { svelteHTML.createElement("svelte:window", {});             /*svn:ignore_start*/void (() => { screenWidth = __svn_any(null); });/*svn:ignore_end*/
        }
        { svelteHTML.createElement("div", {
            "style": `width: ${(screenWidth > LIMIT ? LIMIT : screenWidth) / 2}em;`,
        });
        }
    });
    void screenWidth;
