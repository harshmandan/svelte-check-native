...
function $$render_e40e2c10() {
         ...
         let search: () => unknown[]/*svn:ignore_start*/;search = __svn_any(search);/*svn:ignore_end*/;
    ;(async () => {
        // template type-check body (incremental)
        {
            const __svn_C_69 = __svn_ensure_component(Select);
            new __svn_C_69({ target: __svn_any(), props: {"loadOptions": (search)} });
            { svelteHTML.createElement("span", {});             }
        }
    });
    void search;
    return { props: undefined as any as ({ search: () => unknown[]; }), events: undefined as any as { [evt: string]: CustomEvent<any> }, slots: undefined as any as {}, bindings: undefined as any as string, exports: undefined as any as ({}) };
}
$$render_e40e2c10;
