...
async function $$render_9eb76bb9() {
    async function __svn_tpl_check() {
        ...
        void __svn_bind_pair_5;
        {
            ...
            new __svn_C_9f({ target: __svn_any(), props: {value: (get)()} satisfies InstanceType<typeof __svn_C_9f>['$$prop_def'] });
        }
        {
            const __svn_C_bf = __svn_ensure_component(Input);
            new __svn_C_bf({ target: __svn_any(), props: {value: (() => v)()} satisfies InstanceType<typeof __svn_C_bf>['$$prop_def'] });
        }
    }
