...
function $$render_e40e2c10() {
    ...
    return { props: /** @type {Record<string, never>} */ ({}), events: /** @type {(Omit<({ "click": HTMLElementEventMap["click"] }), keyof ({ "foo": CustomEvent<any> })> & ({ "foo": CustomEvent<any> }))} */ ({}), slots: {}, bindings: /** @type {string} */ (''), exports: {} };
}
$$render_e40e2c10;
