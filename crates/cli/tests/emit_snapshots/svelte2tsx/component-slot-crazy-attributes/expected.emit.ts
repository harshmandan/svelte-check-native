...
function $$render_e40e2c10() {
    ...
    return { props: /** @type {Record<string, never>} */ ({}), events: /** @type {{ [evt: string]: CustomEvent<any> }} */ ({}), slots: { 'default': { a: (b), b: (b), c: ("b"), d: /** @type {string} */ (/** @type {any} */ (null)), e: (b) } }, bindings: /** @type {string} */ (''), exports: {} };
}
$$render_e40e2c10;
