...
function $$render_e40e2c10() {
    ...
    return { props: /** @type {Record<string, never>} */ ({}), events: /** @type {{ [evt: string]: CustomEvent<any> }} */ ({}), slots: { 'default': { foo: (__svn_instance_of(Parent).$$slot_def['default'].foo) } }, bindings: /** @type {string} */ (''), exports: {} };
}
$$render_e40e2c10;
