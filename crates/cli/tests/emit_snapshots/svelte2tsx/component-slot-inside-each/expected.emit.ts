...
function $$render_e40e2c10() {
    ...
    ;(async () => {
        ...
        for (let item of __svn_each_items(items)) {
            {
                __svn_create_slot("default", { a: (item) });
            }
        }
    ...
    return { props: /** @type {Record<string, never>} */ ({}), events: /** @type {{ [evt: string]: CustomEvent<any> }} */ ({}), slots: { 'default': { a: ((__svn_unwrap_arr(items))) }, 'second': { a: ((({ a }) => a)(__svn_unwrap_arr(items2))) } }, bindings: /** @type {string} */ (''), exports: {} };
}
$$render_e40e2c10;
