...
function $$render_e40e2c10() {
    ...
    return { props: /** @type {Record<string, never>} */ ({}), events: /** @type {{ [evt: string]: CustomEvent<any> }} */ ({}), slots: { 'default': { n: (__svn_instance_of(Component).$$slot_def['default'].name), thing: (__svn_instance_of(Component).$$slot_def['default'].thing), bla: ((({ bla }) => bla)(__svn_instance_of(Component).$$slot_def['default'].whatever)) } }, bindings: /** @type {string} */ (''), exports: {} };
}
$$render_e40e2c10;
