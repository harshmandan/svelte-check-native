...
function $$render_e40e2c10() {
    ...
    return { props: /** @type {Record<string, never>} */ ({}), events: /** @type {(({ "click": HTMLElementEventMap["click"] })) & { [evt: string]: CustomEvent<any> }} */ ({}), slots: { 'default': {  } }, bindings: /** @type {string} */ (''), exports: {} };
}
$$render_e40e2c10;
