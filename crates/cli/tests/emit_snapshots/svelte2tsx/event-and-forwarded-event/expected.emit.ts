...
function $$render_e40e2c10() {
    ...
    return { props: /** @type {any} */({}), events: /** @type {(Omit<({ "focus": HTMLElementEventMap["focus"] }), keyof ({ "mount": CustomEvent<any> })> & ({ "mount": CustomEvent<any> })) & { [evt: string]: CustomEvent<any> }} */ ({}), slots: {}, bindings: /** @type {string} */ (''), exports: {} };
}
$$render_e40e2c10;
