...
function $$render_e40e2c10() {
    ...
    return { props: /** @type {Record<string, never>} */ ({}), events: /** @type {(({ "click": __SvnComponentEvents<typeof Button>["click"] })) & { [evt: string]: CustomEvent<any> }} */ ({}), slots: {}, bindings: /** @type {string} */ (''), exports: {} };
}
$$render_e40e2c10;
