...
function $$render_e40e2c10() {
    ...
    return { props: /** @type {Record<string, never>} */ ({}), events: /** @type {(Omit<({ "click": HTMLElementEventMap["click"] }), keyof ({ "hi": CustomEvent<any>, "bye": CustomEvent<any> })> & ({ "hi": CustomEvent<any>, "bye": CustomEvent<any> })) & { [evt: string]: CustomEvent<any> }} */ ({}), slots: {}, bindings: /** @type {string} */ (''), exports: {} };
}
$$render_e40e2c10;
