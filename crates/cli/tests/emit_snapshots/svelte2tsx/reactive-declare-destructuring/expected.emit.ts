...
let { a } = __svn_invalidate(() => ({ a: '' }));
let { b: d } = __svn_invalidate(() => ({ b: '' }));
let { c: { length } } = __svn_invalidate(() => ({ c: '' }));
let { ...e } = __svn_invalidate(() => ({ f: ''}));
let { f } = __svn_invalidate(() => ({ f: ''}));
let { b: g = 1} = __svn_invalidate(() => ({ b: 1 }));
    ;(async () => {
