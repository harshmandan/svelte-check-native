...
/** @typedef {{ form: import('./$types.js').ActionData, data: import('./$types.js').PageData, params: import('./$types.js').PageProps['params'] }} $$ComponentProps */
function $$render_aad4163e() {

    let { form, data, params } = /** @type {$$ComponentProps} */ ($props());
