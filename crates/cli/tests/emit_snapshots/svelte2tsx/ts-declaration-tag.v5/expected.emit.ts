...
async function $$render_c1bd06ac() {
    type $$Events = {};
...
const __svn_component_default: import('svelte').Component<
    Awaited<ReturnType<typeof $$render_c1bd06ac>>['props'],
    Awaited<ReturnType<typeof $$render_c1bd06ac>>['exports'],
    Awaited<ReturnType<typeof $$render_c1bd06ac>>['bindings']
> = null as any;
