...
function $$render_e40e2c10() {
    ...
    void SOME;
    void CONSTANT;
    return { props: /** @type {{ name?: string; SOME?: typeof SOME; CONSTANT?: typeof CONSTANT; }} */({}), events: /** @type {{ [evt: string]: CustomEvent<any> }} */ ({}), slots: {}, bindings: /** @type {string} */ (''), exports: /** @type {{ name: string; SOME: typeof SOME; CONSTANT: typeof CONSTANT; }} */ ({}) };
}
$$render_e40e2c10;
