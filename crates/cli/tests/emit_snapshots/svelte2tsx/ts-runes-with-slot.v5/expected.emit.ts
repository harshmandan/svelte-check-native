...
async function $$render_17f189ba<T>() {
    ...
    void x;
    void y;
    return { props: undefined as any as (Props), events: undefined as any as $$Events, slots: { 'default': { x: (x), y: (y) } }, bindings: undefined as any as string, exports: undefined as any as ({}) };
}
$$render_17f189ba;
