...
interface $$IsomorphicComponent {
    new <T>(options: import('svelte').ComponentConstructorOptions<__SvnSvelte4SlotedProps<ReturnType<__svn_Render_17f189ba<T>['props']>, ReturnType<__svn_Render_17f189ba<T>['props']> & __SvnSvelte4PropsWiden<ReturnType<__svn_Render_17f189ba<T>['props']>>>>): import('svelte').SvelteComponent<Partial<ReturnType<__svn_Render_17f189ba<T>['props']> & __SvnSvelte4PropsWiden<ReturnType<__svn_Render_17f189ba<T>['props']>>>, ReturnType<__svn_Render_17f189ba<T>['events']>, ReturnType<__svn_Render_17f189ba<T>['slots']>> & { $$bindings?: ReturnType<__svn_Render_17f189ba<T>['bindings']> } & ReturnType<__svn_Render_17f189ba<T>['exports']>;
    <T>(internal: unknown, props: __SvnSvelte4SlotedProps<ReturnType<__svn_Render_17f189ba<T>['props']>, ReturnType<__svn_Render_17f189ba<T>['props']> & __SvnSvelte4PropsWiden<ReturnType<__svn_Render_17f189ba<T>['props']>>>): ReturnType<__svn_Render_17f189ba<T>['exports']> & { $set?: any; $on?: any };
