...
function $$render_e40e2c10() {
    let $$slots = __svn_slots_type({'foo': '', 'dashed-name': '', 'default': ''});
    void $$slots;
    ...
    return { props: /** @type {Record<string, never>} */ ({}), events: /** @type {{ [evt: string]: CustomEvent<any> }} */ ({}), slots: { 'foo': {  }, 'dashed-name': {  }, 'default': {  } }, bindings: /** @type {string} */ (''), exports: {} };
}
$$render_e40e2c10;
